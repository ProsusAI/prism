...
<reference>
@/Users/gaurav/codes/prism/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/gaurav/codes/prism/.claude/get-shit-done/references/user-profiling.md` to load:
