---
name: extract-skills
description: "Extract reusable, framework-agnostic skills from an agent codebase analysis report and generate registry-ready skill files. TRIGGER when: a full_report.md has been generated by /analyze-agent-codebase, the user runs /extract-skills, the user asks to extract skills from an analysis."
---
...
and tell the user to run `/analyze-agent-codebase` first.
...
- If `full_report.md` does not exist, fail immediately with a message to run `/analyze-agent-codebase` first.
